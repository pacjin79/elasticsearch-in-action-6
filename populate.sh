...
curl -s -H 'Content-Type: application/json' -XDELETE "$ADDRESS/get-together" > /dev/null

# Create the next index using mapping.json
echo "Creating 'get-together' index..."
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together" -d@$(dirname $0)/mapping.json

# Wait for index to become yellow
curl -s -H 'Content-Type: application/json' "$ADDRESS/get-together/_health?wait_for_status=yellow&timeout=10s" > /dev/null
echo
...
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/1" -d'{
  "name": "Denver Clojure",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/2" -d'{
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/3" -d'{
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/4" -d'{
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/5" -d'{
...
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/100" -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/101?routing=1" -d'{
  "host": "Sean",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/102?routing=1" -d'{
  "host": "Daniel",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/103?routing=2" -d'{
  "host": "Lee",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/104?routing=2" -d'{
  "host": "Lee",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/105?routing=2" -d'{
  "host": "Lee",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/106?routing=3" -d'{
  "host": "Mik",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/107?routing=3" -d'{
  "host": "Mik",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/108?routing=3" -d'{
  "host": "Elyse",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/109?routing=4" -d'{
  "host": "Andy",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/110?routing=4" -d'{
  "host": "Andy",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/111?routing=4" -d'{
  "host": "Andy",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/112?routing=5" -d'{
  "host": "Dave Nolan",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/113?routing=5" -d'{
  "host": "Dave",
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "$ADDRESS/get-together/doc/114?routing=5" -d'{
  "host": "Yann",
...
curl -s -H 'Content-Type: application/json' -XPOST "$ADDRESS/get-together/_refresh"
...
curl -s -H 'Content-Type: application/json' -XPUT "http://$ADDRESS/_template/logging_index_all" -d'{
...
echo
curl -s -H 'Content-Type: application/json' -XPUT "http://$ADDRESS/_template/logging_index" -d '{
    "template" : "logstash-*",
    "order" : 0,
    "settings" : {
        "number_of_shards" : 2,
...
curl -s -H 'Content-Type: application/json' -XDELETE "http://$ADDRESS/myindex" > /dev/null
curl -s -H 'Content-Type: application/json' -XPUT "http://$ADDRESS/myindex" -d'
{
    "mappings" : {
        "my_type" : {
            "dynamic_templates" : [{
...
echo
echo "Adding Aliases"
curl -s -H 'Content-Type: application/json' -XDELETE "http://$ADDRESS/november_2014_invoices" > /dev/null
curl -s -H 'Content-Type: application/json' -XDELETE "http://$ADDRESS/december_2014_invoices" > /dev/null
curl -s -H 'Content-Type: application/json' -XPUT "http://$ADDRESS/november_2014_invoices" -d'{}'
echo
curl -s -H 'Content-Type: application/json' -XPUT "http://$ADDRESS/december_2014_invoices" -d'
{
    "mappings" :
    {
        "invoice" :
...
curl -s -H 'Content-Type: application/json' -XPOST "http://$ADDRESS/_aliases" -d'
{
  "actions" : [
